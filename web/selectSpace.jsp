...
<body class="">
  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
          <h3> You are in Building <%=request.getParameter("buildNo")%> under floor <%=request.getParameter("floorNo")%></h3>
          <table style="overflow:auto" border="1">  
              <th>Space Number</th>
              <th>Book </th>
          <%  int spaces = Integer.parseInt(request.getParameter("free"));
           ...
           <tr>
               ...
               <td>   
                   ...
                   <a href="checkIn.jsp?buildNo=<%=request.getParameter("buildNo")%>&floorNo=<%=request.getParameter("floorNo")%>&parkingNo=<%=i%>&free=<%=request.getParameter("free")%>"> 
                       <div style="cursor:  pointer" id="space<%=i%>" class="square"><img src="assets/img/car.png"></div>
                   </a>
    ...
    margin-top: -60%;
    width: 40%;" src="assets/img/carParking.gif">   
</div>
