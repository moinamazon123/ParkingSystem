...
<body class="">
      ...
      <%=request.getParameter("parkingNo")%>
       ...
       try {
        int freeParking =0;
          ...
          rs = st.executeQuery("select total_free,total_occupied from bulding_floor_map where bulding_no='"+ request.getParameter("buildingNo")+"' and floor_no="+ request.getParameter("floorNo") );
             while(rs.next()){
  ...
  int userId =0;
      ...
      preparedStmt.setInt (1,freeParking-1 );
      preparedStmt.setInt (2, total_occupied+1);
       preparedStmt.setString (3,  request.getParameter("buildingNo"));
   ...
   int rowsAffecrted =   preparedStmt.executeUpdate();
       if(rowsAffecrted>0) {
        System.out.println("Successfully created");
         ...
         String insertquery = " insert into booking (building_no, floor_no, parking_no, checkinDate,userId)"
        + " values (?, ?, ?, ?,?)";
  
      // create the mysql insert preparedstatement
       preparedStmt = con.prepareStatement(insertquery);
      preparedStmt.setString (1, request.getParameter("buildingNo"));
      preparedStmt.setInt (2,  Integer.parseInt(request.getParameter("floorNo")));
      preparedStmt.setInt   (3, Integer.parseInt(request.getParameter("parkingNo")));
      preparedStmt.setString(4, request.getParameter("checkinDate"));
      preparedStmt.setInt    (5,  Integer.parseInt(request.getParameter("userId")));
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Booking Confirmation 
          </div>
